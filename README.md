...
54 agent skills for reasoning, context engineering, and professional work. Works with Claude Code, Cursor, Codex, and [40+ agents](https://github.com/vercel-labs/skills#available-agents).
...
/plugin install craftwork-professional@craftwork            # 20 architecture/communication skills (includes orchestrator)
/plugin install craftwork-all@craftwork                     # everything (54 skills)
```
...
├── craftwork-professional/       → 20 skills (includes orchestrator)
└── craftwork-all/                → 54 skills (all orchestrators)
