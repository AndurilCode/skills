...
description: "Apply this skill whenever the user is evaluating a decision, opportunity, strategy, investment, or belief that has quantifiable stakes — especially when intuition and math might diverge. Triggers on phrases like 'should I do this?', 'is this worth it?', 'what are my odds?', 'I've already invested so much', 'everyone else is succeeding at this', 'how much should I bet on this?', or any decision involving probability, money, risk, or long-term commitment. Also trigger when the user seems to be reasoning from anecdotes, gut feel, or sunk costs rather than expected value. This skill is mandatory-process: it applies all 6 models to every input without exception. Never skip a model."
---
